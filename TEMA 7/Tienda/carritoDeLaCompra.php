...
<html>
  ...
  <body>
    ...
    $articulos = [ 
      "baquetas" => array( "nombre" => "Baquetas de punta de madera", "precio" => 5, "imagen" => "baqueta.png"),
    "sillin" => array( "nombre" => "Sillin de cuero", "precio" => 150, "imagen" => "sillin.jpg"),
    "bateria" => array( "nombre" => "Bateria Mapex", "precio" => 875, "imagen" => "bateria.jpg"),
    "platos" => array( "nombre" => "Set de platos Sabian", "precio" =>605, "imagen" => "sabian.jpg")
     ];
    ?>
    <div id="nombreTienda">
        <h1><img src="imagenes/titulo.png" width="200px;"></h1>
    </div>
    <div id="contenedor"> 
      <!--muestra articulos-->
      <table id="articulos">
        <tr>
          <td colspan="4"><h3> Articulos</h3></td>
        </tr>
        <tr>
        <?php
