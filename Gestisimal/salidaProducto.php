    ...
    <body>
        <?php
            ...
            if($accion == "entrada"){ //al ser igual se actualizan los datos
                $restaStock = $producto->stock - $_POST[stock];
                $modificacion = "UPDATE articulo SET stock=\"$restaStock\" WHERE codigo=\"$_POST[codigo]\"";
        ...
        ?>
        <form method="post" action="salidaProducto.php">
            <div>
